...
class Aluno extends ComponenteAluno{
    constructor(ra, nome, notas, status, faltas){
        super();
        this.ra = ra;
        this.nome = nome;
        this.notas = notas;
...
// Criando Alunos:
const aluno1 = new Aluno("João da Silva", [8.2, 7.5, "MS", "P3", "MF"], [4, 0, 0, 0, 2]);
const aluno2 = new Aluno("Aline da Silva", [0.2, 6.5, "MS", "P3", "MF"], [0, 3, 0, 0, 2]);
const aluno3 = new Aluno("Paulo da Silva", [4.8, 5.5, "MS", "P3", "MF"], [4, 0, 0, 0, 2]);
const aluno4 = new Aluno("Bruno da Silva", [1.2, 2.5, "MS", "P3", "MF"], [0, 3, 0, 2, 2]);
